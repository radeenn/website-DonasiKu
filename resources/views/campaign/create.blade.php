...
<div class="page-hero">
    ...
    <p>Lengkapi data campaign, rekening penerimaan, dan kategori sesuai materi ORM.</p>
</div>
...
<div class="form-section">
    ...
    <form action="{{ route('campaign.store') }}" method="POST" class="form-card">
        @csrf
        ...
        <div class="section-box">
            ...
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required class="form-input" placeholder="Contoh: Bantu Korban Banjir">
                </div>
                <div class="form-group full">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="description" rows="4" required class="form-input" placeholder="Deskripsi lengkap campaign...">{{ old('description') }}</textarea>
                </div>
                <div class="form-group">
                    <label class="form-label">Target Donasi (Rp)</label>
                    <input type="number" name="target_donation" value="{{ old('target_donation') }}" required min="0" class="form-input" placeholder="10000000">
                </div>
                <div class="form-group">
                    <label class="form-label">Dana Terkumpul (Rp)</label>
                    <input type="number" name="collected_donation" value="{{ old('collected_donation', 0) }}" min="0" class="form-input" placeholder="0">
                </div>
                <div class="form-group full">
        ...
        <div class="section-box">
            ...
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input type="text" name="bank_name" value="{{ old('bank_name') }}" required class="form-input" placeholder="Contoh: BRI, BSI, BCA">
                </div>
                <div class="form-group">
                    <label class="form-label">Nomor Rekening</label>
                    <input type="text" name="account_number" value="{{ old('account_number') }}" required class="form-input" placeholder="Nomor rekening">
                </div>
                <div class="form-group">
                    <label class="form-label">Nama Pemilik Rekening</label>
                    <input type="text" name="account_holder" value="{{ old('account_holder') }}" required class="form-input" placeholder="Nama pemilik rekening">
                </div>
            </div>
        </div>
